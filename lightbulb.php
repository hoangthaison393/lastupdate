...
<?php
    ...
    $welcome = "";
    if(isset($_GET['lightbulbid']) == TRUE){
    $productid = $_GET['lightbulbid'];
    $product = new product;   
                                ...
                                <p class="productintro">Product introduction</p>
                                    ...
                                    <div class="slide-content">
                                        ...
                                        <ul style="display: inline;">
                                            <li id="parameter"><p>Wattage<span style="margin-left: 5px;">:<?php echo " ".$para1; ?></p></li>
                                            <li id="parameter"><p>Lifespan<span style="margin-left: 4.5px;">:<?php echo " ".$para2; ?></span></p></li>
                                            <li id="parameter"><p>Origin<span style="margin-left: 32px;">:<?php echo " ".$para3; ?></span></p></li>
                                        </ul>
                                        </div>
                                    </div>
                                </div>
